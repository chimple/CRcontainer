...
public class WebApp extends BaseActivity {
    ...
    private static String ZIP_BASE_URL = "https://raw.githubusercontent.com/chimple/curious-learning-assests/main/";
                ...
                fetchAsset.downloadAssets(lessonId, new FetchAsset.LessonCallBack() {
                    ...
                    public void onSucccess(File lessonFolder) {
                        ...
                        try {
                            ...
                            new Thread(() -> {
                                try {
                                    java.net.URL url = new java.net.URL("http://127.0.0.1:8401/" + filename);
                                    java.net.HttpURLConnection conn = (java.net.HttpURLConnection) url.openConnection();
                                    conn.setRequestMethod("GET");
                                    int responseCode = conn.getResponseCode();
                                    Log.d("StorageAssetServer", "Test HTTP GET /" + filename + ", response: " + responseCode);
                                } catch (Exception e) {
