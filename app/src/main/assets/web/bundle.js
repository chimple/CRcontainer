var Bundle = (() => {
    ...
    define("App", ["require", "exports", "utils/urlUtils", "survey/survey", "assessment/assessment", "utils/unityBridge", "analytics/analyticsEvents", "utils/jsonUtils", /* "workbox-window", */ "components/cacheModel", "ui/uiController", "utils/androidBridge"], function (require, exports, urlUtils_3, survey_1, assessment_1, unityBridge_1, analyticsEvents_3, jsonUtils_4, /* workbox_window_1, */ cacheModel_1, uiController_4, androidBridge_2) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        exports.App = void 0;
            ...
            spinUp() {
                return __awaiter(this, void 0, void 0, function* () {
                    window.addEventListener('load', () => {
                        ...
                        if ((_a = window.Android) === null || _a === void 0 ? void 0 : _a.sendInstalledAppInfoToJS) {
